...
// /:accountId/peers
export interface PeerDTO extends PeerBaseDTO, Pick<AvatarDTO, 'avatar'|'avatarfull'> {
	account_id:AccountId,
...
// GET /matches/:MatchId
export interface UnparsedMatchDTO extends MatchSummaryDTO, MatchScoreDTO, MatchSeriesDTO {
	players: UnparsedPlayerDTO[],
	...
	//not present on anonymous matches
	region?:RegionId, // region ID from dotaconstants
}

export interface ParsedMatchDTO extends UnparsedMatchDTO {
...
export interface UnparsedPlayerDTO extends
PlayerSummaryDTO, GameFormatDTO, OdRelation,
Partial<PlayerRankDTO>, Partial<AccountBaseDTO>, MatchCountDTO, InventoryDTO {
...
export interface ParsedPlayerDTO extends UnparsedPlayerDTO {
	obs_placed:number,
	sen_placed:number,
	...
	match_id?:MatchId,
	additional_units?:AdditionalUnit[]|null,
}
export interface AdditionalUnit extends InventoryDTO {
	unitname:string,
}
...
export interface PauseDTO {time:number,	duration:number}
// GET /distributions
